...
public class AuthenticateService {
	...
	public LoginResponseDTO authenticateOauth(String googleToken) {
		...
		if (!user.isPresent()) {
			User newUser = new User(email, "", Role.USER, responseObject.getName(), Gender.UNKNOWN, true, DateTimeUtil.milisecondToDate(System.currentTimeMillis()), responseObject.getPicture(), LoginType.GOOGLE, false);
