...
//				friendService.addFriend(2l, 4l);
				...
				mealPlannerRepository.save(new MealPlanner(null, recipe, admin, MealType.DINNER, DateTimeUtil.milisecondToDate(System.currentTimeMillis() - (1000*60*60*24*2))));
				mealPlannerRepository.save(new MealPlanner(null, recipe, admin, MealType.DINNER, DateTimeUtil.milisecondToDate(System.currentTimeMillis())));
